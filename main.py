...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_dir', type=str, default="results", help='directory where to save the results')
    ...
    if not os.path.exists(f"./{results_dir}/" + args.dataset):
        os.makedirs(f"./{results_dir}/" + args.dataset)
    if not os.path.exists(f"./{results_dir}/" + args.dataset + "/agent_topk=" + args.agent_topk):
        os.makedirs(f"./{results_dir}/" + args.dataset + "/agent_topk=" + args.agent_topk)
    result_base_path = f"./{results_dir}/" + args.dataset + "/agent_topk=" + args.agent_topk + "/"
